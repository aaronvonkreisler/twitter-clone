...
import {addTweetToBookmarks, removeTweetFromBookmarks} from '../../actions/bookmarks';
...
export default connect(null, {addTweetToBookmarks, removeTweetFromBookmarks})(ToolbarMenu);
