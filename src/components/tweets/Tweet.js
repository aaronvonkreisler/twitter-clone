        ...
        <div className="flex flex-col">
          ...
          <article className="tweet__wrapper flex flex-row">
            ...
            <div className="tweet__content flex flex-col justify-between">
              ...
              <Link to={`/${tweet.user.screen_name}/status/${tweet._id}`}>
                <ViewOnlyEditor
                      ...
                      >
                        ...
                        <div className="metrics">
                          <span className="metrics__item">
                            {displayNumbers && tweet.replies.length > 0 && (
                          ...
                          <span className="metrics__item">
                            {displayNumbers &&
                              tweet.retweetUsers.length > 0 && (
                                <span> {tweet.retweetUsers.length}</span>
                              )}
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="tweetAction-item">
                    <div className="flex flex-col justify-center">
                      ...
                      >
                        ...
                        <div className="metrics">
                          <span className="metrics__item">
                            {displayNumbers && tweet.favorites.length > 0 && (
